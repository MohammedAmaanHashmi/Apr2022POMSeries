...
public class RegisterPage {
	...
	public boolean userRegistration(String firstName, String lastName, String email, String telephone, String password,
		...
		String actSucessMesg = eleUtil.waitForElementVisible(this.sucessMessg, AppConstants.MEDIUM_DEFAULT_TIME_OUT)
				.getText();

		System.out.println("user reg sucess message==========" + actSucessMesg);

		if (actSucessMesg.contains(AppConstants.REGISTER_SUCCESS_MESSAGE)) {
